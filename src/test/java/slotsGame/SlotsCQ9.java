...
public class SlotsCQ9 extends VariablesStore {
	...
	private static String nameOfReport = "SlotsCQ9";
	...
	@Parameters({ "vendorCQ9" })
	public void selectSlotsVendor(String vendorCQ9) throws FailedLoginException, InterruptedException {
		cR.createTest("selectSlotsVendor");
		sGCVAG.hoverGameCategory("2");
		sGCVAG.selectGameVendor(vendorCQ9);
	}
