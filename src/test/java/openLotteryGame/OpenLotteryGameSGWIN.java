...
public class OpenLotteryGameSGWIN extends VariablesStore {
	...
	private static String nameOfReport = "OpenLotteryGameSGWIN";

	@BeforeClass(groups = { "Start", "SGWIN" })
	...
	@Test(priority = 2, groups = { "login", "SGWIN" })
	@Parameters({ "userIDFE" })
	...
	@AfterMethod(groups = { "SGWIN" })
	public void logCaseStatus(ITestResult result) {
		rL.logCaseStatus(result);
	}

	@AfterClass(groups = { "SGWIN" })
