...
public class SelectLiveCasinoGame extends VariablesStore {
	...
	public void selectLiveCasino() throws FailedLoginException {
		fail = "selectLiveCasino failed";

		wait = new WebDriverWait(bDriver.getDriver(), 15);
		WebElement selectLiveCasino = bDriver.getDriver().findElement(By.xpath("(//div[@class='header_menu_item'])[5]"));
		wait.until(ExpectedConditions.elementToBeClickable(selectLiveCasino));
		String selectLiveCasinoText = selectLiveCasino.getText();
