...
public class OpenESportsGameIM extends VariablesStore {
	...
	private static String nameOfReport = "OpenLiveGameIM";

	@BeforeClass(groups = { "Start", "IM" })
	...
	@Test(priority = 2, groups = { "login", "IM" })
	@Parameters({ "userIDFE" })
	...
	@AfterMethod(groups = { "IM" })
	public void logCaseStatus(ITestResult result) {
		rL.logCaseStatus(result);
	}

	@AfterClass(groups = { "IM" })
